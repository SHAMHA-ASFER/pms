<div class="container p-4">
    <h3 class="mb-5">Allocated Projects</h3>
    <table class="table table-striped" id="projectTable">
        ...
        <tbody>
            <?php
            $i = 1;
            $projectQAs = $this->projectQAModel->getAllProjects($_SESSION['id']);
            while ($projectQA = $projectQAs->fetch_assoc()) {
                $projects = $this->projectModel->getProject($projectQA['pro_id']);
